...
const CustomDate = ({ open, label, type = 'text', value, touched, error, onBlur, onChange, onFocus,
  ...
  <div className={`${s.root} ${value ? s.filled : ''} ${className || ''}`}>
    ...
    <DatePicker
      ...
      dateFormat={'YYYY-MM-DD'} minDate={noPast && moment()} maxDate={noFuture && moment()} onFocus={onFocus}
